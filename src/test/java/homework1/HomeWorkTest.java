...
/*
1.
        - Для уже созданных объектов прописать геттеры и сеттеры
        - Создать отдельный класс для работы с ними
        - Для каждого объекта создать копию и заполнить его
        - Сделать вывод информации по этим объектам
*/
