...
public class WorkingWithLists {
    ...
    public void createAndWorkWithLists() {
        ...
        valera.setPhone("+371 23232323");

        Student liga = new Student("Liga", "Ivanova", "liga@test.lv", "+371 22222222");
        ...
        for (int i = 0; i < students.size(); i++) {   //    students.size() - длина всего списка
            System.out.println(students.get(i).getFirstName());


//      for (int i = 0; i < 2; i++) {   //    i = i + 1    ==    i++
//          System.out.println(students.get(i).getFirstName());
